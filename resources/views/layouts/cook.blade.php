          ...
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <a class="navbar-brand" href="{{ url('cook') }}"><img src="{{ asset('images/logo/logo.png') }}" alt="" width="65" height="30"></a>

                    <li class="nav-item">

                            <a class="nav-link {{ request()->is('cook') ? 'active' : '' }}" href="{{ url('/cook') }}">
                                Активні замовлення
                            </a>
                    </li>
                    <li class="nav-item">

                            <a class="nav-link {{ request()->is('cook/acceptOrders') ? 'active' : '' }}" href="{{ url('/cook/acceptOrders') }}">
                                Готуються
                            </a>
                    </li>
                    <li class="nav-item">

                            <a class="nav-link {{ request()->is('cook/successOrders') ? 'active' : '' }}" href="{{ url('/cook/successOrders') }}">
                                Очікують подачі
                            </a>
                    </li>
