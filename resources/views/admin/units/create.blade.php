...
@section('title','Створити одиницю виміру')
@section('content')
              ...
              <div class="row justify-content-center">
                  <div class="col-md-12">
                      @if(session()->get('success'))
                          ...
                          @endif
                          <form action="{{ route('units.store') }}" method="POST" role="form" enctype="multipart/form-data">
                              {{ csrf_field() }}
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('code_unit')?' has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" name="code_unit" id="code_unit" >
