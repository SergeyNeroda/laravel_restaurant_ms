    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                            ...
                            @forelse ($acceptOrders as $element)
                                  ...
                                  <div class="card" style="margin:10px">
                                    ...
                                    <div class="card-footer ">
                                      <div class="row">
                                        ...
                                        <div class="col-md-3">
                                          <button class="btn btn-primary ready-order" type="button" name="button" value="{{ $element->id }}">Замовлення виконане</button>
                                        </div>
                                      </div>
                            ...
                            <div class="row justify-content-center align-items-center">
                                {{ $acceptOrders->links('layouts.paginate') }}
                            </div>
                          </div>
                        </div>
                        {{-- 3 --}}
