...
@section('title','Приготовані замовлення')
@section('content')
                                  ...
                                  <div class="card" style="margin:10px">
                                    ...
                                    <div class="card-footer ">
                                      <div class="row">
                                        ...
                                        <div class="col-md-3">
                                          <button class="btn btn-primary waiter-ready-order" type="button" name="button" value="{{ $element->id }}">Клієнт отримав замовлення</button>
                                        </div>
                                      </div>
...
//
  $(document).ready(function(){
    $(document).on('click','.waiter-ready-order',function(){

      var id = $(this).val();
      $.ajax({
        type:'get',
        url:'{!! URL::to('/cook/accept/ready') !!}',
        data:{'id':id},
